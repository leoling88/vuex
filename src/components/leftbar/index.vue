...
.ul-1 .t i{display:block;width:.6rem;height:.6rem;position:absolute;top:.7rem;right:.5rem;}
...
.demoSpan1:before{content:''; height:.4rem; width:.6em; display:block; border:1px solid #888; border-right-width:0; border-top-width:0; transform:rotate(-135deg);-webkit-transform:rotate(-135deg);-moz-transform:rotate(-135deg);-o-transform:rotate(-135deg);-ms-transform:rotate(-135deg); position:absolute;}
